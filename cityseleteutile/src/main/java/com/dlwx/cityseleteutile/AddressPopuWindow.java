...
public  class AddressPopuWindow {
     ...
     *
     */
    private static List<SanJiLianDBean.CityList> cityLists;
    private static ViewHolder vh;
    private static String[] pro;
    private static String[] city;
    private static List<SanJiLianDBean.CityList.CBean> citys;
    private static String[] country;
    private static List<SanJiLianDBean.CityList.CBean.aBean> countrys;
    ...
    public static void showWindow(final Context ctx, View parent) {
        View view = LayoutInflater.from(ctx).inflate(R.layout.item_address, null, false);
     ...
     * @return
     */
    private static String[] provinceData(List<SanJiLianDBean.CityList> list){
